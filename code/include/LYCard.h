...
bool WritePCard(u8 *filename,int br,const u8 *userID,const u8 *pswd,double gasValue,u8 bqcs,int zql,u8 *eInfo);
bool WriteUCard(u8 *filename,int br,const u8 *userID,const u8 *pswd,double gasValue,u8 bqcs,u8 *eInfo);
